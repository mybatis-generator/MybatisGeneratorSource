...
//    	compilationUnit.addFileCommentLine(" */");
    	...
    	compilationUnit.addFileCommentLine(" * Copyright (c) 2017, 资邦金服（上海）网络科技有限公司. All Rights Reserved ");
    	compilationUnit.addFileCommentLine(" * " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
    	compilationUnit.addFileCommentLine(" */");
    }
...
//        method.addJavaDocLine(" */"); //$NON-NLS-1$
        ...
        method.addJavaDocLine(" * @MethodName " + method.getName());
